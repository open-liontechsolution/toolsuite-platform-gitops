...
- `values-local-dev.yaml` - Local dev (1 instance, 250m CPU, 512Mi RAM, 20Gi)
- `values-local-qa.yaml` - Local QA (2 instances, 500m CPU, 1Gi RAM, 30Gi)
- `values-local-prod.yaml` - Local prod (3 instances, 1 CPU, 2Gi RAM, 50Gi)
- `values-cloud-dev.yaml` - Cloud dev (2 instances, 500m CPU, 1Gi RAM, 50Gi)
- `values-cloud-qa.yaml` - Cloud QA (2 instances, 1 CPU, 2Gi RAM, 75Gi)
- `values-cloud-prod.yaml` - Cloud prod (3 instances, 2 CPU, 4Gi RAM, 200Gi)
...
- `apps/data/cnpg/values-local-qa.yaml`
- `apps/data/cnpg/values-local-prod.yaml`
- `apps/data/cnpg/values-cloud-dev.yaml`
- `apps/data/cnpg/values-cloud-qa.yaml`
- `apps/data/cnpg/values-cloud-prod.yaml`
